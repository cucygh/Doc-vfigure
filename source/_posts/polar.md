title: 南丁格尔玫瑰图 - 饼(圆环)图
---

### 南丁格尔玫瑰图<a name=stdBar></a>
- [效果图](#effect)
- [安装方式](#install)
- [使用配置](#config)
- [使用方式](#use)
...
<iframe src="http://fex.dev.quhuhu.com/guohui.yin/v-figure/html/polar.html" frameborder="0" width="810" height="350"></iframe>
安装方式：<a name="install"></a> [回到顶部](#stdBar)
``` javascript
    var bar=require('lib/pie/polar.js');
```
